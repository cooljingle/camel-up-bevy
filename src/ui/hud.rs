...
pub fn game_hud_ui(
    ...
    egui::TopBottomPanel::top("game_info").show(ctx, |ui| {
        ui.horizontal(|ui| {
            ...
            ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                ...
                // Show exit fullscreen button if in fullscreen mode
                if let Ok(window) = windows.single() {
                    if window.mode != WindowMode::Windowed {
                        let btn_text = if !ui_state.use_side_panels { "Exit FS" } else { "Exit Fullscreen" };
    ...
    // Process fullscreen exit request
...
fn mobile_players_per_row(count: usize, available_width: f32) -> usize {
    ...
    match count {
        2 => 2,
        3 => 3.min(max_fit),
        4 => if max_fit >= 4 { 4 } else { 2 },  // 4 or 2x2 grid
...
fn render_mobile_ui(
    ...
    egui::TopBottomPanel::top("mobile_info_panel")
        .show(ctx, |ui| {
            ...
            let available_width = ui.available_width();
            let card_width = (available_width / per_row as f32) - 6.0;
...
fn render_desktop_ui(
    ...
    egui::SidePanel::left("player_panel").min_width(220.0).show(ctx, |ui| {
        ...
        ui.add_enabled_ui(can_act, |ui| {
            ...
            let pyramid_size = egui::vec2(70.0, 70.0);
